...
class MessageListCreateView(APIView):
    ...
    def post(self, request, conversation_id):
        ...
        try:
            context, results = rag_service.retrieve_context(
                content,
                request.user,
            )
        except Exception:
        ...
        if context:
            system_message = {
                "role": "system",
                "content": (
                    "You are an AI assistant with access to the user's "
                    "uploaded documents.\n\n"
                    "Use the document context below when it is relevant "
                    "to the user's question.\n"
                    "If the context does not contain enough information, "
                    "say that the uploaded documents do not provide "
                    "enough information. Do not invent facts from "
                    "the documents.\n\n"
                    f"DOCUMENT CONTEXT:\n{context}"
                ),
            }
